...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.lecg.blog.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.lecg.blog.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.lecg.blog.domain.User.class.getName());
            createCache(cm, com.lecg.blog.domain.Authority.class.getName());
            ...
            createCache(cm, com.lecg.blog.domain.Blog.class.getName() + ".subjects");
            createCache(cm, com.lecg.blog.domain.Post.class.getName() + ".subjects");
