...
import com.lecg.blog.service.SubjectService;
import com.lecg.blog.service.dto.SubjectDTO;
import com.lecg.blog.service.mapper.SubjectMapper;
import com.lecg.blog.service.dto.SubjectCriteria;
import com.lecg.blog.service.SubjectQueryService;
...
public class SubjectResourceIT {
    ...
    @Test
    @Transactional
    public void getAllSubjectsByPostIsEqualToSomething() throws Exception {
        // Initialize the database
        subjectRepository.saveAndFlush(subject);
        ...
        // Get all the subjectList where post equals to postId
        defaultSubjectShouldBeFound("postId.equals=" + postId);

        // Get all the subjectList where post equals to postId + 1
        defaultSubjectShouldNotBeFound("postId.equals=" + (postId + 1));
    }


    @Test
    @Transactional
    public void getAllSubjectsByBlogIsEqualToSomething() throws Exception {
        // Initialize the database
        subjectRepository.saveAndFlush(subject);
        ...
        // Get all the subjectList where blog equals to blogId
        defaultSubjectShouldBeFound("blogId.equals=" + blogId);

        // Get all the subjectList where blog equals to blogId + 1
        defaultSubjectShouldNotBeFound("blogId.equals=" + (blogId + 1));
    }
